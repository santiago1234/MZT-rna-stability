...
```{r  bivariate_polyA, fig.height=3.5, fig.width=7}
...
tc_d %>% 
  ...
  labs(
    y = "poly-A WT",
    x = "expression",
    title = "RNA-seq time course dynamics during MZT"
  )
...
```{r polyOverRiboRatio, fig.width=2, fig.height=2}
dtidy %>% 
