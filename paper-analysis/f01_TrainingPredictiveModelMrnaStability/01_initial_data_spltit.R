...
inital_data <- 
  bind_rows(
  read_csv("../../results/19-04-30-PredictiveModelDecayAllSpecies/19-04-30-EDA/results_data/training_set.csv"),
  read_csv("../../results/19-04-30-PredictiveModelDecayAllSpecies/19-04-30-EDA/results_data/validation_set.csv")
) %>% 
...
write_csv(training_data, "data/train.csv")
write_csv(testing_data, "data/testing.csv")
